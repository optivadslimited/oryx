      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded shadow-sm border border-[#E8E4DE] p-8">
          <div className="text-center mb-8">
            <h1 className="font-serif text-2xl font-semibold text-[#0A0F1E] tracking-wide">
              ORYX
            </h1>
            <p className="text-sm text-[#888] mt-1">Admin Panel</p>
          </div>
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <input
                ...
                required
                className="w-full px-4 py-3 border border-[#E8E4DE] rounded bg-white text-[#1A1A1A] focus:outline-none focus:border-[#C9A84C]"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 bg-[#1B2A4A] text-white font-medium uppercase tracking-widest text-sm hover:bg-[#C9A84C] hover:text-[#1A1A1A] transition-colors disabled:opacity-60"
            >
